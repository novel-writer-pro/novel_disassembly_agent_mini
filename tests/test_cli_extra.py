    ...
    class _FakeAssistantService:
        def build_branch_assistant_pack(self, branch_id: str, **kwargs):
            return {
                ...
                'governance_report_brief_pack': {'contract_version': 'governance-report-brief-pack.v1', 'brief_text': '# x', 'summary_card': 'x'},
                'release_review_note_pack': {'contract_version': 'release-review-note-pack.v1', 'note_text': '# x', 'review_status': 'blocked'},
                'approval_decision_memo_pack': {'contract_version': 'approval-decision-memo-pack.v1', 'memo_text': '# x', 'memo_status': 'rejected'},
