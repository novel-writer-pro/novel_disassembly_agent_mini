...
5. [`../../architecture/risk-audit-embedding-pgvector-implementation-spec.md`](../../architecture/risk-audit-embedding-pgvector-implementation-spec.md)
6. [`../../risk-audit-checker-roadmap.md`](../../risk-audit-checker-roadmap.md)
