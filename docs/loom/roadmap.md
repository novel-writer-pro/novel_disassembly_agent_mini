...
✅ Consumer Migration Telemetry：当前 writer control surfaces、live/runtime readiness 与 external runtime simulation bridge 已输出 `session_consumer_migration_telemetry`，标明 primary-ready 与 legacy-remaining 消费方
```
