...
| 🟡 Consumer Migration Telemetry | reward/eval-data-collection | writer control surfaces、live/runtime readiness 以及 external runtime simulation bridge 已输出最小迁移遥测；更细粒度真实 runtime 观测仍待后续扩展 |
